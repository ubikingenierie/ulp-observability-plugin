...
<em>Panneau de configuration JMeter de l'�couteur ULP Observability</em> 
<br/>
<br/>
<img src=screenshot/ulp_observability2.png><br/>
<em>Exemple de r�sum� des m�triques en mode non graphique</em>
</p>
...
<em>Exemple d'histogramme pour une m�trique sp�cifique</em> <br />
</p>
- Axe y gauche�: m�trique de chaque groupe d'�chantillons
- Axe y droit�: nombre de threads cumul�s de chaque groupe d'�chantillons
- Histogrammes actuellement mis en �uvre pour�: r�ponse moyenne, r�ponse maximale, centiles, pourcentage d'erreur et d�bit

<br />
<p align="center">
<img src=screenshot/ulp_observability4.png><br/>
<em>Exemple de r�sum� des m�triques totales</em> <br />
</p>