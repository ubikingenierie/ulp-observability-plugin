...
<#-- the following formatter: ?string["0.0#"] is used to format the double values -->
...
${sampleName}_total{count="error_every_periods",errorType="${errorType_404}",errorRate="${errorRate_404?string["0.0###"]}",errorFreq="${errorFreq_404?string["0.0###"]}"} ${errorOccurrence_404} ${timestamp}<#rt>${'\n'}
