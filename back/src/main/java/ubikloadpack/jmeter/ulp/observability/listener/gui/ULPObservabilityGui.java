...
public class ULPObservabilityGui extends AbstractListenerGui{
   ...
   /**
	* pass the data from the sample Listener to the Gui
	*/
	 @Override
	 public void configure(TestElement testElement) {
		 
		log.info("configure function");
		...
		if (testElement instanceof ULPObservabilityListener) {
			   ...
			   log.info("thread name {}", testElement.getName());
			   //log.info("sample name{}", testElement.getThreadContext().getPreviousResult().getSampleLabel());
			   //ulpObservabilityListener.getMetrics().get(ulpObservabilityListener.get);
			   /**
	...
	*/
    public void modifyTestElement(TestElement element) {
		...
		log.info("getting signals from sampler listener");
